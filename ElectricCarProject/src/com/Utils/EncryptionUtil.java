...
public class EncryptionUtil {
	...
	public static void passwordEncryption(String password, UserTableDTO user) {
		try {
			// 시큐어 랜덤값 생성
			...
			user.setUserPassword(formatValue.toString());
			user.setUserSaltKey(saltKey.toString().trim());
			/**/
	...
	public static boolean passwordConfirm(String password,UserTableDTO user) {
		...
		try {
			...
			String hexaDecimal = user.getUserSaltKey();
		...
		return sb.toString().equals(user.getUserPassword()) ? true : false;
