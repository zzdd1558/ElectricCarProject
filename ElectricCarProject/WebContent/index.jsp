...
<body>
	...
	<div class="w3-bar w3-black" style="position: fixed; z-index: 1000;">
		...
		<div class="w3-bar-item w3-hover-green"><a href="adminViews/manageChargerView.jsp">MANAGE CHARGERS</a></div>
		<div class="w3-bar-item w3-hover-green"><a href="adminViews/manageMemberView.jsp">MANAGE MEMBERS</a></div>
